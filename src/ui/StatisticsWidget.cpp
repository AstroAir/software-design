...
StatisticsWidget::StatisticsWidget(RecordManager* recordManager, CardManager* cardManager,
                                   QWidget* parent)
    : QWidget(parent), m_recordManager(recordManager), m_cardManager(cardManager) {
    initUI();
    refreshStatistics();
}
